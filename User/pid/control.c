...
{	
	...
	Set_Angle(1,Position1-180+129);
	Set_Angle(2,Position2-180+225);
	Set_Angle(3,-Position3+180+40+90);
	Set_Angle(4,Position4-180+135);
 	Set_Angle(5,Position5);
	Set_Angle(6,Position6);
}
