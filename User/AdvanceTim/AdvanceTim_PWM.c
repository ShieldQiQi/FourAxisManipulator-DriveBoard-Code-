...
void Set_Angle(uint8_t channel,float angle)
{
	switch(channel)
	{
		case 1:
			TIM_SetCompare1(TIM8, (angle-135)/270*2000+1500);
			break;
		case 2:
			TIM_SetCompare2(TIM8, (angle-135)/270*2000+1500);
			break;
		case 3:
		...
		case 5:
			...
			break;
		case 6:
			TIM_SetCompare4(TIM1, (angle-135)/270*2000+1500);
			break;		
